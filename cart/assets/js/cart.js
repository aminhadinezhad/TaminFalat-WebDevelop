  ...
  cart.forEach((item, idx) => {
    ...
    const leftBtn =
      item.qty === 1
        ...
        : `<div class="qty-btn">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" color="currentColor" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" onclick="changeQty(${idx}, -1)">
    <path d="M20 12L4 12" />
</svg>
                 </div>`;
    ...
    tr.innerHTML = `
            ...
            <td data-label="قیمت واحد" class="price-col">${item.unitPrice}</td>
            <td data-label="ارزش افزوده" class="added-val">${item.tax}</td>
            <td data-label="تعداد">
            ...
            <td data-label="جمع" class="price-col">${lineTotal}</td>
          `;
